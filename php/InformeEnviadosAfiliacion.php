...
$Datos2 = array();
$ConsultaSQL = "SELECT CLI_CDOCUMENTO, CONCAT (CLI_CNOMBRE,' ',CLI_CNOMBRE2,' ',CLI_CAPELLIDO,' ',CLI_CAPELLIDO2) AS NOMBRE_CLIENTE, PENAFL_CFONDO_NUEVO, PENAFL_COBSERVACIONES_AGENDA, PENAFL_CESTADO_FINAL2_AGENDA, PENALF_CFECHA_REGISTRO, CONCAT (CRE_CNOMBRE,' ',CRE_CAPELLIDO,' ',CRE_CAPELLIDO2) AS NOMBRE_AGENTE FROM u632406828_dbp_crmfuturus.TBL_RCLIENTE, u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION, u632406828_dbp_crmfuturus.TBL_RCREDENCIAL WHERE FKPENAFL_NPKPER_NCODIGO=PKCRE_NCODIGO AND PKCLI_NCODIGO=FKPENAFL_NPKPENCAL_NCODIGO AND PENALF_CFECHA_REGISTRO BETWEEN '". $FechaInicial ."' AND '". $FechaFinal ."' AND PENALF_CESTADO= 'Activo';";
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
    $CantidadResultados = $ResultadoSQL->num_rows;
    if ($CantidadResultados > 0) {
        while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
            ...
            $PENCAL_CFONDO_NUEVO = $FilaResultado['PENAFL_CFONDO_NUEVO'];
            $PENCAL_COBSERVACIONES = $FilaResultado['PENAFL_COBSERVACIONES_AGENDA'];
            $PENCAL_CESTADO_FINAL2 = $FilaResultado['PENAFL_CESTADO_FINAL2_AGENDA'];
            $PENALF_CFECHA_REGISTRO = $FilaResultado['PENALF_CFECHA_REGISTRO'];
            $NOMBRE_AGENTE = $FilaResultado['NOMBRE_AGENTE'];

            
            array_push($Datos2, array("0" => $CLI_CDOCUMENTO, "1" => $NOMBRE_CLIENTE, "2" => $PENCAL_CFONDO_NUEVO, "3" => $PENCAL_CESTADO_FINAL2, "4" => $PENALF_CFECHA_REGISTRO, "5" => $NOMBRE_AGENTE, "6" => $PENCAL_COBSERVACIONES));
        }
    } else {
        $NOMBRE_CLIENTE = " ";
        $PENCAL_CFONDO_NUEVO = " ";
...
<head>
    <title> Informe Enviados a Afiliacion :: Futurus </title>
    <meta charset="utf-8">
...
<body class="theme-cyan">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center !important;">
                        <div class="navbar-brand d-none d-sm-block d-md-block" style="margin-bottom: 3%;">
                            <h4>INFORME DE ENVIADOS A AFILIACION</h4>
                        </div>
    ...
    <div class="container">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  frm">
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">Fondo Nuevo</th>
            ...
            <div>
                <form method="POST" action="InformeEnviadosAfiliacion.php" enctype="multipart/form-data">
