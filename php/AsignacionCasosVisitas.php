...
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
    ...
    mysqli_close($ConexionSQL);
    echo '<script>alert("Error Falla -> ' . $ErrorConsulta . '");</script>';
    echo "<script>window.location='AsignacionCasosVisitas.php';</script>";
    exit;
}
...
<head>
    <title>Asignacion Casos Visita :: Futurus</title>
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center !important;">
                        <div class="navbar-brand d-none d-sm-block d-md-block" style="margin-bottom: 3%;">
                            <h6>ASIGNAR CASOS DE VISITAS</h6>
                        </div>
    ...
    <div class="container">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  frm">
            <div class="form-group">
                ...
                <label class="btn btn-primary nextBtn btn-lg center-block btnsig" for="btn-check" style="float: right">SELECCIONAR TODOS</label>
