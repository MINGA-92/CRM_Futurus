...
require('ConsultaNotificacionesAgente.php');
session_start();
...
} else if (isset($_GET['CodigoCasoVencido'])) {
    $CASOS = 1;
    $CODIGO_CASO = $_GET['CodigoCasoVencido'];
...
if ($CASOS == 1) {
    ...
    $ConsultaSQL = "SELECT EST_CDETALLE FROM u632406828_dbp_crmfuturus.TBL_RESTANDAR WHERE EST_CCONSULTA = 'cmbAtencionHomeOffice' AND EST_CESTADO = 'Activo' GROUP BY EST_CDETALLE;";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
    ...
    //Listado Contacto
    $ListadoContacto = "";
    $ConsultaSQL = "SELECT DISTINCT EST_CDETALLE1, EST_CDETALLE2 FROM u632406828_dbp_crmfuturus.TBL_RESTANDAR WHERE EST_CCONSULTA = 'cmbAtencionHomeOffice' AND EST_CDETALLE = 'Contacto' AND EST_CESTADO = 'Activo';";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
    ...
    //Listado No Contacto
    $ListadoNoContacto = "";
    $ConsultaSQL = "SELECT DISTINCT EST_CDETALLE1 FROM u632406828_dbp_crmfuturus.TBL_RESTANDAR WHERE EST_CCONSULTA = 'cmbAtencionHomeOffice' AND EST_CDETALLE = 'No Contacto' AND EST_CESTADO = 'Activo';";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
    ...
    //Listado No Aplica
    $ListadoNoAplica = "";
    $ConsultaSQL = "SELECT DISTINCT EST_CDETALLE1, EST_CDETALLE2 FROM u632406828_dbp_crmfuturus.TBL_RESTANDAR WHERE EST_CCONSULTA = 'cmbAtencionHomeOffice' AND EST_CDETALLE = 'No Aplica' AND EST_CESTADO = 'Activo';";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
    ...
    $Datos2 = array();
    $ConsultaSQL = "SELECT DETCLI_CDETALLE, DETCLI_CDETALLE1 FROM u632406828_dbp_crmfuturus.TBL_RDETALLE_CLIENTE WHERE FKDETCLI_NCLI_NCODIGO= '". $LLAVECONSULTA ."' AND DETCLI_CCONSULTA= 'FondosAnteriores' GROUP BY DETCLI_CDETALLE1;";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
    ...
    //Consulta Incentivo 
    $ListadoIncentivo = "";
    $ConsultaSQL = "SELECT DISTINCT EST_CDETALLE1 , EST_CDETALLE FROM u632406828_dbp_crmfuturus.TBL_RESTANDAR WHERE EST_CCONSULTA = 'cmbIncentivo' AND EST_CESTADO = 'Activo'";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
                $ListadoIncentivo = $ListadoIncentivo . '<option value="' . $FilaResultado['EST_CDETALLE'] . '">' . $FilaResultado['EST_CDETALLE'] . '</option>';
            }
        } else {
            //Sin Resultados
        }
    ...
    $Datos1 = array();
    $ConsultaSQL = "SELECT CLI_CDOCUMENTO, CLI_CNOMBRE, CLI_CAPELLIDO, CLI_CESTADO FROM u632406828_dbp_crmfuturus.TBL_RCLIENTE, u632406828_dbp_crmfuturus.TBL_RDETALLE_CLIENTE WHERE PKCLI_NCODIGO = FKDETCLI_NCLI_NCODIGO AND  DETCLI_CCONSULTA='EmpresaCliente' AND DETCLI_CDETALLE= '". $CODIGOPEMPRESA ."';";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
                ...
                array_push($Datos1, array("0" => $Identificacion, "1" => $Nombre, "2" => $Apellido, "3" => $Estado));
            }
        } else {
            //Sin Resultados
            $Identificacion = "";
...
<head>
    <title> Agente HomeOffice :: Futurus </title>
    <meta charset="utf-8">
...
<body class="theme-cyan">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                                    <div class="row">
                                        ...
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%; margin-top: 2%;">
                                            <input title="' .$Edad. '" id="EdadCliente" style="background-color: #fafffa23;" type="text" class="form-control" required="" value="' .$Edad. '" disabled="True">
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-block d-sm-block d-md-none d-lg-none d-xl-none" style="padding: 0.5%; background-color: #fafffa23; text-align:center; margin-top: 5%">
                                          <a type="button"  class="btn btn-futurus-r"  href="AgregarUnContacto.php">Agregar un Contacto</a>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-none d-sm-none d-md-block d-lg-block d-xl-block"  style="text-align: center; margin-top: 30px;">
                                            <a href="AgregarUnContacto.php">
                                            <button style="position:relative; right:7%;" type="button"  class="btn btn-futurus-r">Agregar un Contacto</button>
                                            </a>
                                        </div>
                                        ...
                                        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" id="LblSalario">
                                            <label style="font-size: 10px; margin-top: 10%; padding-left: 2%; margin-top: 25%;">SALARIO INICIAL CLIENTE</label>
                                        </div>
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%;">
                                            <input id="Salario" title="' . $SALARIOCLIENTE . '" style="background-color: #fafffa23; margin-top: 15%;" type="text" class="form-control input-number" required="" value="' . $SALARIOCLIENTE . '" disabled="disabled">
                                        </div>

                                        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" id="LblConfirmacionSalario">
                                          <label style="font-size: 10px; margin-top: 10%; padding-left: 2%;">CONFIRMACIÓN DE SALARIO</label>
                                        </div>
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%;">
                                          <input id="ConfirmacionSalario" title="" style="background-color: #fafffa23;" type="text" class="form-control input-number" required="" value="" >
                                        </div>
                                        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%;" id="LblBonoCliente">
                                          <label style="font-size: 10px; margin-top: 10%;">BONO DE PENSION</label>
                                          <option selected="" hidden="" disabled="">Opciones</option>
                                        </div>
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%;">
                                          <select id="BonoCliente" name="BonoCliente" style="background-color: #fafffa23;" class="form-control" required="">
                                            <option selected="" hidden="" disabled="">Opciones</option>
                                            ' . $ListadoIncentivo . '
                                          </select>
                                        </div>
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-none d-sm-none d-md-block d-lg-block d-xl-block" style="text-align: center; margin-top: 25px;">
                                            <button type="button" class="btn btn-futurus-r" data-toggle="modal" data-target="#DatosCompromiso">Agregar Compromiso</button>
                                        </div>
                                        
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-block d-sm-block d-md-none d-lg-none d-xl-none" style="padding: 0.5%; background-color: #fafffa23; text-align:center; margin-top: 105px">
                                           <button  type="button"  class="btn btn-futurus-r" data-toggle="modal" data-target="#DatosCompromiso">Agregar compromiso</button>
                                        </div>
                                        ...
                                        <div id="FechaGestion" class="col-10 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="padding: 0.5%; margin-top: 2%">
                                            <input id="FechaRegistro" title="'. $FechaHoy .'" style="background-color: #fafffa23;" type="datetime-local" class="form-control" required="" value="'. $FechaHoy .'">
                                        </div>
                                        ...
                                        <div id="TituloFechaALlamar" class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4" style="padding: 0.5%;">
                                            <label style="font-size: 10px; margin-top: 10%; margin-left: 15%;">FECHA Y HORA PARA LLAMAR</label>
                                        </div>
                                        <div id="FechaALlamar" class="col-10 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="padding: 0.5%; margin-top: 2%">
                                            <input id="FechaALlamar2" title="'. $FechaHoy .'" style="background-color: #fafffa23;" type="datetime-local" class="form-control" required="" value="">
                                        </div>
                                        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" id="LblIncentivo">
                                            <label style="font-size: 10px; margin-top: 12%; padding-left: 2%;"> VALOR INCENTIVO</label>
                                        </div>
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%; margin-top: 2%;">
                                            <input id="Incentivo" title="' . $DescripcionIncentivo . '" style="background-color: #fafffa23;" type="text" class="form-control" required="" value="' . $DescripcionIncentivo . '" disabled="disabled">
                                        </div>

                                        <div class="row">
                                            <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" id="LblFondoActual2">
                                                <label style="font-size: 10px; margin-top: 12%; padding-left: 2%;">FONDO ACTUAL</label>
                                            </div>
                                            <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%; margin-top: 2%;">
                                                <input id="FondoActual2" title="' . $FONDOACTUAL . '" style="background-color: #fafffa23;" type="text" class="form-control" required="" value="' . $FONDOACTUAL . '" disabled="disabled">
                                            </div>

                                            <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" id="LblFondoEnvia">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center; margin-top: 1%;">
                                    <button id="BtnAnadirAdjuntos" type="button" class="btn btn-futurus-r" data-toggle="modal" data-target="#AnadirAdjuntos">Añadir Datos Adjuntos</button>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="padding: 0.5%; padding-left: 5%;">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center; margin-top: 1%;">
                                    <button id="Registro" name="Registro" type="button" class="btn btn-futurus-r">Registrar</button>
                                </div>

                                <script>
                                    //$("#NotasAdicionales").val("'. $ObservacionesAnteriores .'");
                                    setTimeout(function(){
                                        var notasAdic = document.getElementById("NotasAdicionales");
                                        notasAdic.value = "'. $ObservacionesAnteriores .'";
                                    }, 1000);
                                </script>
    ...
    <div class="modal" id="NumerosAdicionalesContacto" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btnCerrar" id="btnCerrar" data-dismiss="modal" style="background-color: #61636294; color: #ffffff;">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row" id="ContModal3">
                        ...
                        <input id="NumeroContactoRRHHPrincipal" name="NumeroContactoRRHHPrincipal" type="text" value="<?php echo $DETEMP_CDETALLE2; ?>" hidden="hidden">
                        <div class="col-md-12 col-sm-12 col-lg-12">
                        ...
                        <div class="TablaContactoEncargadoRHH col-sm-12 col-md-12 col-lg-12 col-xl-12" id="TablaContactoEncargadoRHH">
                            <div class="row">
    ...
    <div class="modal" id="DatosCompromiso" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="largeModalLabel" style="color: #5f615fb4;">Datos Adicionales Compromiso</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <label for="FechaIngreso" style="color: #5f615fb4;">Datos Adicionales Compromiso:</label>
                            <textarea id="Compromiso" name="Compromiso" type="textarea" class="form-control w-100" required="" value=""></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button id="CerrarCompromiso" type="button" class="btn" data-dismiss="modal" style="background-color: #61636294; color: #ffffff;">Aceptar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="Modalbtn1" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Detalles Del Bono: </h5>
                ...
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 4%;">
                    <label style="font-size: 10px; margin-top: 10%;">VALOR BONO: </label>
                </div>
                <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 4%;">
                    <input id="ValorBono" style="background-color: #fafffa23; margin-top: -2%;" type="number" class="form-control" required="">
                </div>
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 4%;">
                    <label style="font-size: 10px; margin-top: 10%;">DESCRIPCION BONO: </label>
                </div>
                <div class="modal-body">
                    <textarea id="DetalleBono" name="DetalleBono" class="form-control" rows="0" cols="30" style="background-color: #fafffa23; margin-top: -4%;" required=""></textarea>
                </div>
                <div class="modal-footer">
                                ...
                                <div class="body table-responsive">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            ...
                                            <div class="body">
                                                <form method="POST" action="GuardarCasoHomeOffice.php" enctype="multipart/form-data">
                                                    ...
                                                    <input id="ConfirmacionSalarioL" name="ConfirmacionSalarioL" hidden="true">
                                                    <input id="IncentivoL" name="IncentivoL" hidden="true">
                                                    <input id="FechaGestionL" name="FechaGestionL" hidden="true">
                                                    <input id="FechaReagendamientoL" name="FechaReagendamientoL" hidden="true">
                                                    ...
                                                    <input id="CantidadAdjuntos" name="CantidadAdjuntos" value="1" hidden="true">
                                                    <input type="text" id="Agente" name="Agente" value="<?php echo $AGENTE; ?>" hidden="hidden">
                                                    <input type="text" id="CodigoCaso" name="CodigoCaso" hidden="true" value="<?php echo $CODIGO_CASO ?>">
                                                    ...
                                                    <!-- <input type="text" id="InputDetalleAdjunto1" name="InputDetalleAdjunto1" value=""> -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#LblSalario').hide();
            $('#Salario').hide();
            $('#LblConfirmacionSalario').hide();
            $('#ConfirmacionSalario').hide();
            $('#LblBonoCliente').hide();
            $('#BonoCliente').hide();
            $('#LblFondoActual2').hide();
            $('#FondoActual2').hide();
            $('#LblFondoEnvia').hide();
            $('#FondoEnvia').hide();
            $('#BtnAnadirAdjuntos').hide();
            $('#TituloFechaALlamar').hide();
            $('#FechaALlamar').hide();
        ...
        $(document).ready(function() {
            ...
            if(sessionStorage.getItem("fecha_gestion") == null){
                ...
                if(sessionStorage.getItem("fecha_gestion") == ""){
                    console.log("fecha_gestion Vacia");
            ...
            $('#SubObservacion').on('change', function() {
                ...
                var DetalleAtencion = $("#SubObservacion option:selected").text();
                if (DetalleAtencion == "Envio De Afiliacion Exitoso"){
                    $('#LblSalario').show();
                    $('#Salario').show();
                    $('#LblConfirmacionSalario').show();
                    $('#ConfirmacionSalario').show();
                    $('#LblBonoCliente').show();
                    $('#BonoCliente').show();
                    $('#LblFondoActual2').show();
                    $('#FondoActual2').show();
                    $('#LblFondoEnvia').show();
                    $('#FondoEnvia').show();
                    $('#BtnAnadirAdjuntos').show();

                } else if ((DetalleAtencion == "Volver a Llamar") || (DetalleAtencion == "Cliente Indeciso")){
                    $('#TituloFechaALlamar').show();
                    $('#FechaALlamar').show();
                    $('#LblSalario').hide();
                    $('#Salario').hide();
                    $('#LblConfirmacionSalario').hide();
        ...
        function resetearSessionStorage(){
            ...
            window.location.assign("Frankenstein.php");
        ...
        //Actualizacion de datos adicionales Empresa
        ...
        //Mostrar Modal
        $("#BonoCliente").on("change", function() {
            var valor = $(this).val();
        ...
        $("#BtnAceptar").click(function() {
            $('#LblIncentivo').show();
            $('#Incentivo').show();
            DescripcionIncentivo = $("#ValorBono").val();
            $("#Incentivo").val(DescripcionIncentivo);
        });

        //Actualizar Fondo Anterior
        $("#FondoActual").on("change", function() {
            FondoOld = $(this).val();
            $('#FondoActual2').val(FondoOld);
        });

        //Actualizar Fondo Nuevo
        $("#EstadoCliente").on("change", function() {
            FondoNew = $(this).val();
            $('#FondoEnvia').val(FondoNew);
        });
        ...
        $('#AddFilaAdjunto').click(function() {
            ...
            if (CantidadFilas < 1) {
                ...
                <tr class="FilaAdjunto" id="FilaAdjunto${CodigoNuevo}">
                    ...
                    <td id="CasillaFileAdjunto${CodigoNuevo}"> <input name="archivo${CodigoNuevo}" id="archivo${CodigoNuevo}" type="file" class="form-control-file"> </td>
            ...
            `);
                ...
                if ((UltimoInput == '') || (UltimoInput == null) || (UltimoInput.length < 1)) {
                    alert('Por favor ingrese una descripción para el detalle del archivo adjunto');
                } else if ((UltimoTextoDetalle == '') || (UltimoTextoDetalle == null) || (UltimoTextoDetalle.length < 1)) {
                    alert('Presione el botón de guardar en la columna Modificar');
                } else {
                    ...
                    <tr class="FilaAdjunto" id="FilaAdjunto${CodigoNuevo}">
                        <td id="CasillaDetalleAdjunto${CodigoNuevo}"><input id="InputDetalleAdjunto${CodigoNuevo}" name="InputDetalleAdjunto${CodigoNuevo}" maxlength="10" type="mail" class="form-control transparencia" required=""> <p id="TextoDetalleAdjunto${CodigoNuevo}" class="TextoDetalleAdjunto"></p></td>
                        <td id="CasillaFileAdjunto${CodigoNuevo}"> <input id="archivo${CodigoNuevo}" name="archivo${CodigoNuevo}" type="file" class="form-control-file"> </td>
                        <td id="CasillaCambiosAdjunto${CodigoNuevo}" style="text-align: center;"><button type="button" id="CapturaAdjunto${CodigoNuevo}" class="btn btn-futurus-r CapturaAdjunto" data-target="${CodigoNuevo}"><i class="fa icon-check"></i></button> <button type="button" id="ModificarTextoAdjunto${CodigoNuevo}" class="btn btn-futurus-r ModificarTextoAdjunto" data-target="${CodigoNuevo}" style="display: none;"><i class="fa icon-note"></i></button></td>
                        <td id="CasillaCancelarAdjunto${CodigoNuevo}" style="text-align: center;"><button type="button" class="btn btn-futurus-r CancelarAdjunto" data-target="${CodigoNuevo}"><i class="fa icon-close"></i></button></td>
                    </tr>
                `);
        ...
        function IniciarFunciones() {
            ...
            $('.CapturaAdjunto').click(function(Captura) {
                id = $(this).attr('data-target');
                var ValorInput = $('#InputDetalleAdjunto' + id).val();

                if (ValorInput == '' || ValorInput.length < 1) {
                    alert("Se Debe Agregar Una Descripcion Corta Del Archivo Adjunto");
                } else {
                    $('#InputDetalleAdjunto' + id).hide();
                    $('#TextoDetalleAdjunto' + id).html(ValorInput);
                    $('#TextoDetalleAdjunto' + id).show();
                    $(this).hide();
                    $('#ModificarTextoAdjunto' + id).show();
                    alert("Archivo Adjunto Cargado Correctamente");
                }
                window.Capturar = ValorInput;
            });
            ...
            $('body').on('click', '#btnCompromiso', function(event) {
        ...
        $("#Registro").click(function() {
            ...
            var EstadoAtencion = $("#EstadoAtencion option:selected").text();
            var SubObservacion = $("#SubObservacion option:selected").text();
            ...
            var CantidadAdjuntos = $("#CantidadAdjuntos").val();
            //var InputDetalleAdjunto = Capturar;


            if (EstadoAtencion == 'Opciones') {
                alert("Debe seleccionar una opción en el campo Estado Atención"); 
                $("#Loading4").hide();
                $("#main").show();
            } else if ((ValorEmpresa == 'Opciones') || (ValorEmpresa == null)){
                ...
                $("#Loading4").hide();
                $("#main").show();
            } else if (SubObservacion == 'Opciones') {
                alert("Debe seleccionar una opción en el campo Detalle Atención");
                $("#Loading4").hide();
                $("#main").show();
                ...
                alert("Debe llenar las observaciones de llamada");
                $("#Loading4").hide();
                $("#main").show();
                ...
                $("#Loading4").hide();
                $("#main").show();
            }else if (estado == undefined && FechaRegistro != '') {
                alert("Debe seleccionar la fecha y hora del campo fecha gestion");
                $("#Loading4").hide();
                $("#main").show();
            } else if (estado != undefined && FechaRegistro == '') {

                if (EstadoAtencion == 'No Contacto'){

                    if(SubObservacion == "Viable En El Futuro"){
                        
                        if(FechaFuturo == "" || FechaFuturo == null){
                            alert("Debe Seleccionar Una Fecha, Dentro Del Mes De Viabilidad");
                            $("#Loading4").hide();
                            $("#main").show();
                            $("#TituloFechaFuturo").show();
                            $("#FechaFuturo").show();
                        }else{
                            alert("Este Caso Estara Disponible Para Gestionar Despues Del" + " " + FechaFuturo);
                            $("#Loading4").show();
                            $("#main").hide();

                            ConfirmacionSalario= "N/A";
                            BonoCliente= "N/A";
                            DetalleBono= "N/A";
                            ValorBono= " ";
                            CantidadAdjuntos= "N/A";
                            Compromiso = "N/A";
                            FechaALlamar = "";

                            $.ajax({
                                url: "GuardarCasoHomeOffice.php",
                                type: "POST",
                                data: {
                                    ...
                                    ConfirmacionSalario: ConfirmacionSalario,
                                    BonoCliente: BonoCliente,
                                    DetalleBono: DetalleBono,
                                    ValorBono: ValorBono,
                                    Compromiso: Compromiso,
                                    FechaALlamar: FechaALlamar,
                                    CantidadAdjuntos: CantidadAdjuntos
                                    //InputDetalleAdjunto: InputDetalleAdjunto
                                }
                            }).done(function(data) {
                                Resultado = String(data);
                                if (Resultado == 1) {
                                    alert("¡Caso Gestionado Exitosamente! 😊");
                                    $("#Loading4").hide();
                                    $("#main").show();
                        ...
                        if (EstadoAtencion == 'No Contacto'){
                            ...
                            $.ajax({
                                ...
                                if (Resultado == 1) {
                                    ...
                                    $("#main").show();
                                    resetearSessionStorage();
                                    window.location.assign("AgenteCall.php");
                                } else if (Resultado == 2) {
                                    alert("¡Actualizado Exitosamente!");
                                    $("#Loading4").hide();
                                    $("#main").show();
                    ...
                    if((SubObservacion == "Volver a Llamar") || (SubObservacion == "Cliente Indeciso")){

                        var FechaALlamar = $("#FechaALlamar2").val();
                        ConfirmacionSalario= "N/A";
                        BonoCliente= "N/A";
                        DetalleBono= "N/A";
                        ValorBono= " ";
                        ...
                        if(FechaALlamar == "" || FechaALlamar == null){
                            alert("Debe Seleccionar Una Fecha, Para Llamar Al Cliente Luego 🤨");
                            $("#Loading4").hide();
                            $("#main").show();
                            $("#TituloFechaALlamar").show();
                            $("#FechaALlamar").show();
                        ...
                        if (EstadoAtencion == 'No Aplica'){
                            ...
                            if ((SubObservacion == "No Le Interesa") || (SubObservacion == "Cliente Molesto")){
                                ...
                                if (SubObservacion == "Envio De Afiliacion Exitoso"){
                                    ...
                                    var ConfirmacionSalario = $("#ConfirmacionSalario").val();
                                    var Compromiso = $("#Compromiso").val();
                                    let BonoCliente = $('#BonoCliente option:selected').val();
                                    let DetalleBono = $('#DetalleBono').val();
                                    let ValorBono = $('#ValorBono').val();
                                    FechaALlamar = "";

                                    if (ConfirmacionSalario == "" || ConfirmacionSalario == null){
                                        alert("Se Debe Confirmar El Salario");
                                        $("#Loading4").hide();
                                        $("#main").show();
                                        $('#LblSalario').show();
                                        $('#Salario').show();
                                        ...
                                        $('#FondoEnvia').show();
                                        $('#BtnAnadirAdjuntos').show();
                                    } else if (BonoCliente == 'Opciones') {
                                        alert("Debe Seleccionar Una Opción En El Campo 'Bono De Pensión'");
                                        $("#Loading4").hide();
                                        $("#main").show();
                                    } else if ((DetalleBono == '') || (DetalleBono.length < 1) || (DetalleBono == null)) {
                                        alert("Debe Ingresar Una Descripción En La Ventana 'Detalle Del Bono Pensión' Que Aparece Al Seleccionar Un 'Bono De Pensión'");
                                        $("#Loading4").hide();
                                        $("#main").show();
                                    } else if ((ValorBono == '') || (ValorBono.length < 1) || (ValorBono == null)) {
                                        alert("Debe Ingresar Un Valor En La Ventana 'Detalle Del Bono Pensión' Que Aparece Al Seleccionar Un 'Bono De Pensión'");
                                        $("#Loading4").hide();
                                        $("#main").show();
                                    } else if ((Compromiso == '') || (Compromiso.length < 1) || (Compromiso == null)) {
                                        alert("Debe Ingresar Un Compromiso En La Ventana Que Aparece Al Dar Click En El Boton 'Agregar Compromiso'");
                                        $("#Loading4").hide();
                                        $("#main").show();
                                    } else{
                                        ...
                                        $.ajax({
                                            ...
                                            if (Resultado == 1) {
                                                ...
                                                alert("😫  Error:  No Se Pudo Realizar Ninguna Accion!  😭");
                                                $("#Loading4").hide();
                                                $("#main").show();
                                                console.log(Resultado);
                                            }
                                    ...
                                    if (SubObservacion == "Desistimiento o Retracto"){
                                        ...
                                        if (ConfirmacionSalario == "" || ConfirmacionSalario == null){
                                            ...
                                            alert("Debe Ingresar Un Texto En La Ventana 'Detalle Del Bono Pensión' Que Aparece Al Seleccionar Un 'Bono De Pensión'");
                                            $("#Loading4").hide();
                                            $("#main").show();
                                        } else{
                                        ...
                                        if(SubObservacion == "Mas Adelante"){
                        
                                            if(FechaFuturo == "" || FechaFuturo == null){
                                                alert("Debe Seleccionar Una Fecha, Para Gestionar En El Futuro");
                                                $("#Loading4").hide();
                                                $("#main").show();
                                                $("#TituloFechaFuturo").show();
                                                $("#FechaFuturo").show();
                                            ...
                                            alert("¡Se Debe Diligenciar Todo El Formulario!");
                                            $("#Loading4").hide();
                                            $("#main").show();
