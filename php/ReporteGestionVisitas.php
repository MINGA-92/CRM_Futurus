...
//Datos informe agente visitas
$ConsultaSQL = "SELECT COUNT(PENAFL_CESTADO_FINAL_AGENDA) AS CONTADOR1  FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL_AGENDA = 'Agenda Exitosa' AND PENALF_CESTADO = 'Activo';";
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
    $CantidadResultados = $ResultadoSQL->num_rows;
    if ($CantidadResultados > 0) {
...
$ConsultaSQL2 = "SELECT COUNT(PENAFL_CESTADO_FINAL_AGENDA) AS CONTADOR2  FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL_AGENDA = 'Pendiente' AND PENALF_CESTADO = 'Activo';";
...
$ConsultaSQL3 = "SELECT COUNT(PENAFL_CESTADO_FINAL2_AGENDA) AS CONTADOR3 FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL2_AGENDA = 'Afiliacion Exitosa' AND PENALF_CESTADO = 'Activo';";
...
$ConsultaSQL4 = "SELECT COUNT(PENAFL_CESTADO_FINAL2_AGENDA) AS CONTADOR4 FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL2_AGENDA = 'Documentos Pendientes' AND PENALF_CESTADO = 'Activo';";
...
$ConsultaSQL5 = "SELECT COUNT(PENAFL_CESTADO_FINAL2_AGENDA) AS CONTADOR5 FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL2_AGENDA = 'Retracto' AND PENALF_CESTADO = 'Activo';";
...
$ConsultaSQL6 = "SELECT COUNT(PENAFL_CESTADO_FINAL2_AGENDA) AS CONTADOR6 FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL2_AGENDA = 'Cliente No Atiende' AND PENALF_CESTADO = 'Activo';";
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL6)) {
    $CantidadResultados = $ResultadoSQL->num_rows;
    if ($CantidadResultados > 0) {

        while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
            $CONTADOR6 = $FilaResultado['CONTADOR6'];
        }
    } else {
        $CONTADOR6="";
    }
...
$ConsultaSQL7 = "SELECT COUNT(PENAFL_CESTADO_FINAL2_AGENDA) AS CONTADOR7 FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL2_AGENDA = 'Reagendamiento' AND PENALF_CESTADO = 'Activo';";
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL7)) {
    $CantidadResultados = $ResultadoSQL->num_rows;
    if ($CantidadResultados > 0) {

        while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
            $CONTADOR7 = $FilaResultado['CONTADOR7'];
        }
    } else {
        $CONTADOR7="";
    }
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['Task', 'Hours per Day'],
                ['Agenda Exitosa', <?php echo $CONTADOR1 ?>],               
                ['Afiliacion Exitosa', <?php echo $CONTADOR3 ?>],
                ['Documentos Pendientes', <?php echo $CONTADOR4 ?>],
                ['Retracto', <?php echo $CONTADOR5 ?>],

            ]);

            var options = {
                title: 'Reporte Exitoso Visitas',
                is3D: true,
            };
...
<script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['Task', 'Hours per Day'],
                ['Pendiente', <?php echo $CONTADOR2 ?>],
                ['Cliente No Atiende', <?php echo $CONTADOR6 ?>],
                ['Reagendamiento', <?php echo $CONTADOR7 ?>]
            ]);

            var options = {
                title: 'Reporte Pendientes Visitas',
                is3D: true,
            };
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center !important;">
                        <div class="navbar-brand d-none d-sm-block d-md-block" style="margin-bottom: 3%;">
                            <h4>REPORTE DE GESTION VISITAS</h4>
                        </div>
