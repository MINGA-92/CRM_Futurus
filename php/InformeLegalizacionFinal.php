...
$TablaDatos ="";
$ConsultaSQL = "SELECT CLI_CDOCUMENTO, concat(CLI_CNOMBRE,' ', CLI_CNOMBRE2,' ',CLI_CAPELLIDO, ' ' ,CLI_CAPELLIDO2) AS NOMBRE, PENAFL_CESTADO_FINAL, PENAFL_COBSERVACIONES,PENAFL_CESTADO_FINAL2, CRE_CUSUARIO, PENAFL_CFECHA_CONFIRMACION, CRE_CDOCUMENTO FROM u632406828_dbp_crmfuturus.TBL_RCLIENTE, u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION, u632406828_dbp_crmfuturus.TBL_RCREDENCIAL WHERE PKCLI_NCODIGO = FKPENAFL_NPKPENCAL_NCODIGO AND PKCRE_NCODIGO = FKPENAFL_NPKPER_NCODIGO_LEGALIZADOR AND PENAFL_CFECHA_CONFIRMACION BETWEEN '" . $FechaInicial . "' AND '" . $FechaFinal . "' AND PENALF_CESTADO = 'Activo' AND PENAFL_CESTADO_FINAL IS NOT NULL;";
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
    $CantidadResultados = $ResultadoSQL->num_rows;
    if ($CantidadResultados > 0) {
        while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
            ...
            $EstadoGestion = $FilaResultado['PENAFL_CESTADO_FINAL'];
            $Observaciones = $FilaResultado['PENAFL_COBSERVACIONES'];
            $DetalleGestion = $FilaResultado['PENAFL_CESTADO_FINAL2'];
            $Usuario = $FilaResultado['CRE_CUSUARIO'];
            $FechaRegistro = $FilaResultado['PENAFL_CFECHA_CONFIRMACION'];
...
<head>
    <title>Informe Legalización Final :: Futurus</title>
    <meta charset="utf-8">
...
<body class="theme-cyan">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center !important;">
                        <div class="navbar-brand d-none d-sm-block d-md-block" style="margin-bottom: 3%;">
                            <h4>INFORME DE LEGALIZACIÓN FINAL</h4>
                        </div>
    ...
    <div class="container">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  frm">
            ...
            <div>
            <form method="POST" action="InformeLegalizacionFinal.php" enctype="multipart/form-data">
