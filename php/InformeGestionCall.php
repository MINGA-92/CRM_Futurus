...
<head>
    <title> Informe Gestion Call :: Futurus </title>
    <meta charset="utf-8">
...
<body class="theme-cyan">
    ...
    <div class="container">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  frm">
            ...
            <div>
                <form method="POST" action="InformeGestionCall.php" enctype="multipart/form-data">
