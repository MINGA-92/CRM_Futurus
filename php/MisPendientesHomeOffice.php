...
$Datos2 = array();
$ConsultaSQL = "SELECT PKPENCAL_NCODIGO, CLI_CDOCUMENTO AS DOCUMENTO, CONCAT (CLI_CNOMBRE,' ',CLI_CNOMBRE2,' ',CLI_CAPELLIDO,' ',CLI_CAPELLIDO2) AS NOMBRE_CLIENTE, PENCAL_CFONDO_NUEVO AS FONDO, PENCAL_CESTADO_FINAL2 AS EstadoCliente, PENCAL_CFECHA_EXPEDIENTE AS FechaLlamar FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_CALL, u632406828_dbp_crmfuturus.TBL_RCLIENTE, u632406828_dbp_crmfuturus.TBL_RDETALLE_CLIENTE WHERE PKCLI_NCODIGO = FKDETCLI_NCLI_NCODIGO AND FKPENCAL_NPKCLI_NCODIGO = PKCLI_NCODIGO AND DETCLI_CCONSULTA = 'FondoPensionCliente' AND FKPENCAL_NPKPER_NCODIGO = " . $AGENTE . " AND (PENCAL_CESTADO_FINAL2 = 'Cliente Indeciso' OR PENCAL_CESTADO_FINAL2 = 'Volver a Llamar' OR PENCAL_CESTADO_FINAL2 = 'Rellamada') AND PENCAL_CESTADO = 'Activo';";
...
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
    ...
    if ($CantidadResultados > 0) {
        while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
            ...
            $FechaParaLlamar = $FilaResultado['FechaLlamar'];
            ...
            array_push($Datos2, array("0" => $CLI_CDOCUMENTO, "1" => $CLI_CNOMBRE, "2" => $DETCLI_CDETALLE, "3" => $EstadoCliente, "4" => $FechaParaLlamar, "5" => $NumeroCliente, "6" => $PKPENCAL_NCODIGO));
        }
    } else {
        //Sin Resultados
    }
                            ...
                            <table id="tabla" class="table table-bordered table-striped table-responsive-sm-md-lg-xl dt-responsive table-hover dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Fecha Para Llamar</th>
                                        <th style="text-align: center;">Numero De Telefono</th>
