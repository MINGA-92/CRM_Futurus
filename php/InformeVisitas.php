...
$TablaDatos = "";
$ConsultaSQL = "SELECT CLI_CDOCUMENTO, concat(CLI_CNOMBRE,' ', CLI_CNOMBRE2,' ',CLI_CAPELLIDO, ' ' ,CLI_CAPELLIDO2) AS NOMBRE, PENAFL_CESTADO_FINAL_AGENDA, PENAFL_COBSERVACIONES_AGENDA,PENAFL_CESTADO_FINAL2_AGENDA, CRE_CUSUARIO, PENALF_CFECHA_REGISTRO, CRE_CDOCUMENTO FROM u632406828_dbp_crmfuturus.TBL_RCLIENTE, u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION, u632406828_dbp_crmfuturus.TBL_RCREDENCIAL WHERE PKCLI_NCODIGO = FKPENAFL_NPKPENCAL_NCODIGO AND PKCRE_NCODIGO = FKPENAFL_NPKPER_NCODIGO AND PENALF_CFECHA_REGISTRO BETWEEN '" . $FechaInicial . "' AND '" . $FechaFinal . "' AND PENALF_CESTADO = 'Activo' AND PENAFL_CESTADO_FINAL_AGENDA IS NOT NULL;";
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
    $CantidadResultados = $ResultadoSQL->num_rows;
    if ($CantidadResultados > 0) {
        while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
            ...
            $EstadoGestion = $FilaResultado['PENAFL_CESTADO_FINAL_AGENDA'];
            $Observaciones = $FilaResultado['PENAFL_COBSERVACIONES_AGENDA'];
            $DetalleGestion = $FilaResultado['PENAFL_CESTADO_FINAL2_AGENDA'];
            $Usuario = $FilaResultado['CRE_CUSUARIO'];
            $FechaRegistro = $FilaResultado['PENALF_CFECHA_REGISTRO'];
            ...
            $TablaDatos .= '
                    <tr>
                        ...
                        <td style="text-align: center;">' . $EstadoGestion . '</td>
                        <td style="text-align: center;">' . $DetalleGestion . '</td>
                        ...
                        <td style="text-align: center;">' . $DocumentoAgente . '</td>
                    </tr>
                ';
        }
    } else {
...
<head>
    <title>Informe Gestion Visitas :: Futurus</title>
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center !important;">
                        <div class="navbar-brand d-none d-sm-block d-md-block" style="margin-bottom: 3%;">
                            <h4>INFORME DE GESTION VISITAS</h4>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-responsive-sm-md-lg-xl dt-responsive table-hover dataTable js-exportable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Detalle Atención</th>
                                            <th style="text-align: center;" hidden>Observaciones</th>
                                            <th style="text-align: center;">Fecha De Gestión</th>
                                            <th style="text-align: center;">Agente Que Gestiona</th>
                                            <th style="text-align: center;">Documento Agente</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
