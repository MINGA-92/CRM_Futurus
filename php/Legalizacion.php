...
if (isset($_POST['codigoExpediente'])) {
    ...
    $CASOVISITA = "";
    $ConsultaSQL = "SELECT PKPENAFL_NCODIGO, FKPENAFL_NPKPENCAL_NCODIGO FROM  u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE FKPENAFL_NPKPER_NCODIGO_LEGALIZADOR = '" . $AGENTE . "' AND PENAFL_CESTADO_FINAL_LEGALIZACION IS NULL AND PENALF_CESTADO = '" . $datos . "' LIMIT 1;";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            $CASOS = 1;
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
                $CASOVISITA = $FilaResultado['PKPENAFL_NCODIGO'];
                $CODIGO_CASO = $FilaResultado['FKPENAFL_NPKPENCAL_NCODIGO'];
            }
        } else {
            //Asignar caso
            $ConsultaSQL = "SELECT PKPENAFL_NCODIGO FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE  PENAFL_CESTADO_FINAL_AGENDA='Agenda Exitosa' AND FKPENAFL_NPKPER_NCODIGO_LEGALIZADOR IS NULL AND PENALF_CESTADO = '" . $datos . "'";
            if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
                $CantidadResultados = $ResultadoSQL->num_rows;
                if ($CantidadResultados > 0) {
                    $CASOS = 1;
                    while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
                        $CASO_ASIGNADO = $FilaResultado['PKPENAFL_NCODIGO'];
                        $ActualizarSql = "UPDATE u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION SET FKPENAFL_NPKPER_NCODIGO_LEGALIZADOR = '" . $AGENTE . "' WHERE PKPENAFL_NCODIGO = '" . $CASO_ASIGNADO . "' AND PENALF_CESTADO = '" . $datos . "'";
...
if ($CASOS == 1) {
        ...
        if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
            ...
            if ($CantidadResultados > 0) {
                while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
                    ...
                    $DETEMP_CDETALLE2 = $FilaResultado['DETEMP_CDETALLE2'];
                }
            } else {
                $NombreRRHH = "";
                $MailRRHH = "";
    ...
    //Consulta FechaEnvioAfiliacion
    $TIPOCONSULTA = "FechaEnvioAfiliacion";
    $ConsultaSQL = "SELECT DETCLI_CDETALLE FROM u632406828_dbp_crmfuturus.TBL_RDETALLE_CLIENTE WHERE FKDETCLI_NCLI_NCODIGO = '" . $LLAVECONSULTA . "' AND DETCLI_CCONSULTA = '" . $TIPOCONSULTA . "' AND DETCLI_CDETALLE != '' AND DETCLI_CESTADO = '" . $datos . "';";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
                $FechaEnvioAfiliacion = $FilaResultado['DETCLI_CDETALLE'];
            }
        } else {
            $FechaEnvioAfiliacion = "";
        }
    } else {
        $ErrorConsulta = mysqli_error($ConexionSQL);
        mysqli_free_result($ResultadoSQL);
    ...
    $ListadoDetalleExitosa = "";
    $ConsultaSQL = "SELECT EST_CDETALLE2 , EST_CDETALLE1 FROM u632406828_dbp_crmfuturus.TBL_RESTANDAR WHERE EST_CCONSULTA = 'cmbAtencionLegalizacion' AND EST_CDETALLE = 'Legalizacion Exitosa' AND EST_CESTADO = 'Activo' AND EST_CDETALLE2 = '1' GROUP BY EST_CDETALLE1;";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
                $ListadoDetalleExitosa = $ListadoDetalleExitosa . '<option value="' . $FilaResultado['EST_CDETALLE1'] . '">' . $FilaResultado['EST_CDETALLE1'] . '</option>';
            }
        } else {
            //Sin Resultados
        }
    ...
    $ListadoDetallePendiente = "";
    $ConsultaSQL = "SELECT EST_CDETALLE2 , EST_CDETALLE1 FROM u632406828_dbp_crmfuturus.TBL_RESTANDAR WHERE EST_CCONSULTA = 'cmbAtencionLegalizacion' AND EST_CDETALLE = 'Pendiente' AND EST_CESTADO = 'Activo' GROUP BY EST_CDETALLE1";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
    ...
    $ConsultaSQL = "SELECT PENALF_CCOMPROMISO, PENAFL_COBSERVACIONES_AGENDA FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE FKPENAFL_NPKPENCAL_NCODIGO = '". $CODIGO_CASO ."' AND PENAFL_CESTADO_FINAL_AGENDA='Agenda Exitosa' AND PENALF_CESTADO = 'Activo';";
    if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
        $CantidadResultados = $ResultadoSQL->num_rows;
        if ($CantidadResultados > 0) {
            while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
...
<head>
    <title>::: Legalizacion ::: Futurus </title>
    <meta charset="utf-8">
            ...
            <div class="col-lg-10 col-md-10">
                ...
                <div class="planned_task">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                                    <div class="row">
                                        ...
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%;">
                                            <input id="ConfirmacionSalario" title="' . $ConfirmacionSalario . '" style="background-color: #fafffa23;" type="text" class="form-control" required="" value="' . $ConfirmacionSalario . '" >
                                        </div>
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%;">
                                            <label style="font-size: 10px; margin-top: 10%; padding-left: 10%;">CANTIDAD DE CAMBIOS</label>
                                        </div>
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 3%; padding-left: 5%;">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="padding: 0.5%; padding-left: 5%; margin-top: 4%;">
                                            <label>DESCRIPCION SIAFP</label>
                                        </div>
                                        <div class="col-sm-12 col-md-10 col-lg-10 col-xl-10" style="padding: 0.5%; padding-left: 5%;">
                                            <input id="DescripcionSiafpCliente" name="DescripcionSiafpCliente" required="" title="' . $TituloResultado . '" style="background-color: #fafffa23;" type="text" class="form-control" required="" value="' . $TituloResultado . '"></input>
                                        </div>
                                        ...
                                        <div id="Div" style="margin-left: 5%; margin-top: 8%; padding-left: 5%;" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 buttom-bar-line"></div>
                                        ...
                                        <div id="FechaEnvioAfiliacion" class="col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%; margin-top: 2%;">
                                          <label id="LblFechaEnvio" style="font-size: 10px; margin-top: 10%; ">FECHA ENVIÓ DE AFILIACIÓN</label>
                                        </div>
                                        <div id="DivFechaGestion" class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%; margin-top: -15%;">
                                            <input id="FechaGestion" title="' . $FechaEnvioAfiliacion . '" style="background-color: #fafffa23; margin-top: 50%;" type="date" class="form-control" required="required" value="' . $hoy . '" disabled="disabled">
                                        </div>

                                        <div id="TituloFechaGestion" class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%;">
                                            <label id="T_FAgendamiento" style="font-size: 10px; margin-top: 5%;">FECHA DE REAGENDAMIENTO</label>
                                        </div>
                                        <div class="col-10 col-sm-5 col-md-5 col-lg-5 col-xl-5" style="padding: 0.5%; padding-left: 5%;">
                                            <input id="FechaReagendamiento" title="' . $FechaReagendamiento . '" style="background-color: #fafffa23;" type="date" class="form-control" required="required" value="' . $FechaReagendamiento . '">
                                        </div>
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                                    <button id="BtnDatosAdjuntos" style="margin-top: 10%;" type="button" class="btn btn-futurus-r" data-toggle="modal" data-target="#AnadirAdjuntos">Ver Datos Adjuntos</button>
                                </div>
                    ...
                    echo '<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center; margin-top: 1%;">
                            <h4>NO HAY CASOS PARA LEGALIZAR</h4>
                            <h6>REVISAR EN "MIS CASOS PENDIENTES"</h6>
                        </div>';
                }
                ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input id="FechaNacimiento" name="FechaNacimiento" type="date" class="form-control transparencia" required="" value="<?php echo $FechaNacimiento; ?>" title="<?php echo $FechaNacimiento; ?>">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="body table-responsive">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            ...
                                            <div class="body">
                                                <form method="POST" action="GuardarLegalizacion.php" enctype="multipart/form-data">
    ...
    <script>
        ...
        $("#SubObservacion").on("change", function() {
            ...
            if (valor == "Legalizacion Exitosa") {
                ...
                $("#DetalleAtencion").append('<?php echo $ListadoDetalleExitosa; ?>');
                ...
                if ((TipoDocumento == "") || (NumeroDocumento == "") || (NewNombreEmpresa == "") || (NombreEncargadoEmpresa == "") || (DireccionEmpresaNueva == "") || (TelefonoEmpresaNueva == "") || (CorreoEncargadoEmpresa == "") || (DireccionNuevaEmpresa == "") || (PaisNuevaEmpresa == "") || (CiudadNuevaEmpresa == "") || (BarrioNuevaEmpresa == "") || (IndicativoNuevaEmpresa == "") || (TelefonoNuevaEmpresa == "") || (ExtencionNuevaEmpresa == "") || (DepartamentoNuevaEmpresa == "")) {
                    ...
                    if (CorreoEncargadoEmpresa.indexOf('@', 0) == -1 || CorreoEncargadoEmpresa.indexOf('.', 0) == -1) {
                        ...
                        $.ajax({
                            ...
                            if (resultado == 1) {
                                window.location = "Legalizacion.php";
        ...
        $('#BtnRegistro').click(function() {
            ...
            form_data.append('ConfirmacionSalario', ConfirmacionSalario);
            var Incentivo = $("#Incentivo").val();
            form_data.append('Incentivo', Incentivo);
            ...
            form_data.append('FechaGestion', FechaGestion);
            var FechaReagendamiento = $("#FechaReagendamiento").val();
            form_data.append('FechaReagendamiento', FechaReagendamiento);
            ...
            if (Agente == "" || Agente == null) {
                ...
                $("#Loading4").hide();
                $("#main").show();
            } else if (ConfirmacionSalario == "" || ConfirmacionSalario == null) {
                alert("Se Debe Confirmar El Salario");
                $("#Loading4").hide();
                $("#main").show();
            } else if (Incentivo == "" || Incentivo == null) {
                alert("Se Debe LLenar El Campo 'Incentivo'");
                $("#Loading4").hide();
                $("#main").show();
            } else if (SubObservacion == "" || SubObservacion == null) {
                alert("Se Debe LLenar El Campo 'Estado De Atencion'");
                $("#Loading4").hide();
                $("#main").show();
            } else if (DetalleAtencion == "" || DetalleAtencion == null) {
                alert("Se Debe LLenar El Campo 'Detalle Atencion'");
                $("#Loading4").hide();
                $("#main").show();
            } else if (FechaGestion == "" || FechaGestion == null) {
                alert("Se Debe LLenar El Campo 'Fecha De Afiliacion'");
                $("#Loading4").hide();
                $("#main").show();
                ...
                //alert(CantidadAdjuntos);
                document.getElementById('ConfirmacionSalarioL').value = ConfirmacionSalario;
                document.getElementById('IncentivoL').value = Incentivo;
                document.getElementById('SubObservacionL').value = SubObservacion;
                document.getElementById('FechaGestionL').value = FechaGestion;
                document.getElementById('DetalleAtencionL').value = DetalleAtencion;
                document.getElementById('FechaReagendamientoL').value = FechaReagendamiento;
        ...
        //Cerrar modal numeros adicionales empresa
