...
//Datos informe agente legalización final
$ConsultaSQL = "SELECT COUNT(PENAFL_CESTADO_FINAL) AS CONTADOR1  FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL = 'Legalizacion Exitosa' AND PENALF_CESTADO = 'Activo';";
if ($ResultadoSQL = $ConexionSQL->query($ConsultaSQL)) {
    $CantidadResultados = $ResultadoSQL->num_rows;
    if ($CantidadResultados > 0) {
        while ($FilaResultado = $ResultadoSQL->fetch_assoc()) {
...
$ConsultaSQL2 = "SELECT COUNT(PENAFL_CESTADO_FINAL2) AS CONTADOR2  FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL2 = 'Afiliacion Totalmente Exitosa' AND PENALF_CESTADO = 'Activo';";
...
$ConsultaSQL3 = "SELECT COUNT(PENAFL_CESTADO_FINAL2) AS CONTADOR3 FROM u632406828_dbp_crmfuturus.TBL_RPENSIONES_AFILIACION WHERE PENAFL_CESTADO_FINAL2 = 'Desistimiento' AND PENALF_CESTADO = 'Activo';";
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['Task', 'Hours per Day'],
                ['Legalizacion Exitosa', <?php echo $CONTADOR1 ?>],               
                ['Afiliacion Totalmente Exitosa', <?php echo $CONTADOR2 ?>],
                ['Desestimiento', <?php echo $CONTADOR3 ?>],

            ]);

            var options = {
                title: 'Reporte Legalización Exitosa',
                is3D: true,
            };
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="text-align: center !important;">
                        <div class="navbar-brand d-none d-sm-block d-md-block" style="margin-bottom: 3%;">
                            <h4>REPORTE DE GESTIONES LEGALIZACION FINAL</h4>
                        </div>
