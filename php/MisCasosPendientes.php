                        ...
                        <div class="row">
                            <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none d-sm-none d-md-none d-lg-block">
                                <div class="navbar-brand" style="margin-top: 1%;">
                                    <a href="AgenteVisitas.php"><img width="50%" src="../images/FUTURUS.png" alt="Lucid Logo" class="img-responsive logo"></a>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 d-block d-sm-block d-md-block d-lg-none" style="text-align: center;">
                                <div class="navbar-brand" style="margin-top: 1%;">
                                    <a href="AgenteVisitas.php"><img width="60%" src="../images/FUTURUS.png" alt="Lucid Logo" class="img-responsive logo"></a>
                                </div>
                            </div>
                                    ...
                                    <?php
                                        ...
                                        for ($i = 0; $i < count($Datos3); $i++) {
                                            ...
                                            for ($b = 0; $b < count($Datos3[$i]); $b++) {
                                                ...
                                                if($b == 5){
                                                    echo '<td style="text-align: center;"><label><a onclick="enviarInformacionVisitas(' . $Datos3[$i][$b] .');" id="SeleccionarCaso" class="btn btn-futurus-r " data-target="1" value=""><i class="fa icon-eye"></i></a><span></span></label></td>';
                                                }else{
