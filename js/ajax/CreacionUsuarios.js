...
$('#Cargo').change(function () {
  ...
  if (cargo == 'AgenteVisitas') {
    $.ajax({
      ...
      $("#Grupo").append('<option value="Crear grupo Nuevo">Crear grupo Nuevo</option>');
      $("#SubGrupo").text('');
    ...
    $.ajax({
      ...
      $("#SubGrupo").append('<option value="Crear Subgrupo Nuevo">Crear grupo Nuevo</option>');
      $("#sec_subgrupo").show();
    });
