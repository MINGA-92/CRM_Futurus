...
(function (global, factory) {
  ...
  var editable = renderer.create('<div id="datos" class="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>');
  ...
  var ui = {
      ...
      button: function ($node, options) {
          return renderer.create('<button id="select-color" type="button" class="note-btn btn btn-light btn-sm" role="button" tabindex="-1">', function ($node, options) {
